    ...
    <div className="cert-award-sc resume-block">
      <div className="container">
        <div className="cert-award-content dotted-border-left">
          <Title titleText={"Zertifikate & Auszeichnungen"} />
...
const CertificateAwardItem = ({ item }) => {
  return (
    <div className="cert-award-item grid items-center" style={{border: "dotted 2px black", borderRadius: "15px", padding: "2%", margin: "1%"}}>
